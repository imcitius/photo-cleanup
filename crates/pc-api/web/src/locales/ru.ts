...
export const ui = {
  ...
  tree: {
    ...
    original: "оригинал",
    quarantine: "Убрать дубликаты оригиналов",
    quarantineHelp:
      "В карантин уйдут точные копии того, что лежит в отмеченных папках, — где бы в архиве они ни лежали. Другие версии снимка остаются: их различает только человек, и для них есть страница «Дубликаты и версии».",
    quarantineNoMarks:
      "Сначала отметьте хотя бы одну папку с оригиналами: без этого убирать нечего.",
  },
...
export const messages = {
  ...
  pe_folder_scope: "Исходные папки, включая вложенные.",
