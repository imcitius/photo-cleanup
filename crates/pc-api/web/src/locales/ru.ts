...
export const messages = {
  ...
  plan_source: "Источник плана",
  plan_originals: "По папкам с оригиналами",
  plan_originals_help:
    "Точные копии файлов из всех отмеченных папок с оригиналами, где бы эти копии ни хранились. Оригиналы остаются. Поиск и выбор папки ограничивают просмотр; подтверждение выполняет весь план, указанный в итоговых числах.",
